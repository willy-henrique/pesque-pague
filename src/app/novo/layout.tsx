...
const NAV_ITEMS = [
  { href: "/novo/dashboard",     label: "Dashboard",     icon: LayoutDashboard },
  { href: "/novo/caixa",         label: "Caixa",         icon: Banknote },
  { href: "/novo/cozinha",       label: "Cozinha",       icon: ChefHat },
  { href: "/novo/bar",           label: "Bar",           icon: GlassWater },
  { href: "/novo/produtos",      label: "Produtos",      icon: Package },
  { href: "/novo/categorias",    label: "Categorias",    icon: Tags },
  { href: "/novo/piques",        label: "Mesas",         icon: MapPin },
  { href: "/novo/promocoes",     label: "Promoções",     icon: Tag },
  { href: "/novo/relatorios",    label: "Relatórios",    icon: BarChart2 },
  { href: "/novo/atendentes",    label: "Atendentes",    icon: UserRound },
  { href: "/novo/usuarios",      label: "Usuários",      icon: Users },
  { href: "/novo/configuracoes", label: "Configurações", icon: Settings },
];
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navBadges: Record<string, number> = {
    "/novo/cozinha": novos.filter((p) => p.itens.some((i) => !i.tipo || i.tipo === "comida")).length,
    "/novo/bar":     novos.filter((p) => p.itens.some((i) => i.tipo === "bebida")).length,
    "/novo/caixa":   comandasAbertas,
  };
